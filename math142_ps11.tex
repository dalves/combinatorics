...
There is a bijection between these functions and paths from $(0, 0)$ to $(n, n-1)$ which consist of single steps $(+1, 0)$ or $(0, +1)$ as follows:
\begin{enumerate}
    \item For each value $a$ in the domain of $f$, draw a dot at $(a, f(a)-1$
\end{enumerate}
